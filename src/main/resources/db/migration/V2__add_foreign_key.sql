...
alter table post_comments add constraint UK_bm1jee7b8w4mmcpto533xjvnu unique (post_id)
alter table post_comments add constraint FKgt0qfmhsm79wnfe87vdj2o4ip foreign key (post_id) references posts (id)
...
alter table post_comments add constraint FKqwj42sg3dn35hr7xsjxql8sic foreign key (user_id) references users (id)
